...
namespace LunaSharp.LunaSharpKernel.Detours.DetouredFunctions
{
    ...
    public class PresentDetour
    {
        ...
        private static string FunctionName => "D3D9::Present";
        public List<IntPtr> devicefunctionaddresses = new List<IntPtr>();
        public Device deviceGlobal;
        private static PresentDetour _instance { get;set; }
        public static PresentDetour Instance => _instance ??= new PresentDetour();
        public PresentDetour()
        {
        ...
        public void CreateHook()
        {
            ...
            var ptr = devicefunctionaddresses[(int)Direct3DDevice9FunctionOrdinals.Present];
            PresentDelegate originalFunction = Marshal.GetDelegateForFunctionPointer<PresentDelegate>(ptr);
            PresentDelegate newFunction = new PresentDelegate(PresentHook);
        ...
        {
            Game.OnGameRenderNative(device);
            var ret = DetoursMgr.GetDetours[FunctionName].CallOriginal(device, sourceRect, destRect, hDestWindowOverride, dirtyRegion);
            return (int)ret;
        }
    }
}
